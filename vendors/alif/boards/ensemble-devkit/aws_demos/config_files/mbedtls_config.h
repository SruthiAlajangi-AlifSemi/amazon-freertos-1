 ...
 * @version  V1.0.0
 * @date
 * @brief    Configuration file for Mbed TLS library.
 * @bug      None.
 * @Note     None.
 ******************************************************************************/

#ifndef CONFIG_FILES_MBEDTLS_CONFIG_H_
#define CONFIG_FILES_MBEDTLS_CONFIG_H_
...
#endif /* CONFIG_FILES_MBEDTLS_CONFIG_H_ */
